            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!!Form::open(['route'=>'monitor.store','method'=>'POST','class'=>'form-horizontal'])!!}
                        ...
                        <div class="form-group">
                            {!!Form::label('Apect ratio',null,['class'=>'col-md-4 control-label'])!!}
                            <div class="col-md-6">
                            {!!Form::text('apect_ratio',null,['class'=>'form-control'])!!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6">
                               <div id="select">
                               {!! Form::select('monitor_pulgada', $pulgadas,['class' => 'form-control']) !!}
                               </div>
                            </div>
                        </div>                                     
